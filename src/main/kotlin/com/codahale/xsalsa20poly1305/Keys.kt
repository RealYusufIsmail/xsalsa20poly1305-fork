...
object Keys {
    ...
    fun generatePrivateKey(): ByteArray {
        ...
        k[0] = (k[0].toInt() and 248.toByte().toInt()).toByte()
        k[31] = (k[31].toInt() and 127.toByte().toInt()).toByte()
        k[31] = (k[31].toInt() or 64.toByte().toInt()).toByte()
        return k
    }
     ...
     */
    fun sharedSecret(publicKey: ByteArray?, privateKey: ByteArray?): ByteArray {
