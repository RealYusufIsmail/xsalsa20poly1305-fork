...
class SimpleBox {
    ...
    fun seal(plaintext: ByteArray): ByteArray {
        val nonce = box.nonce(plaintext)
        val ciphertext = box.seal(nonce, plaintext)
    ...
    fun open(ciphertext: ByteArray): ByteArray? {
        ...
        val nonce = ciphertext.copyOfRange(0, SecretBox.NONCE_SIZE)
        val x = ciphertext.copyOfRange(SecretBox.NONCE_SIZE, ciphertext.size)
